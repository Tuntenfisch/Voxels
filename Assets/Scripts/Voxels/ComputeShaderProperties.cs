...
namespace Tuntenfisch.Voxels
{
    internal static class ComputeShaderProperties
    {
        ...
        public static readonly int NoiseLayers = Shader.PropertyToID("noiseLayers");
        public static readonly int NumberOfNoiseLayers = Shader.PropertyToID("numberOfNoiseLayers");
