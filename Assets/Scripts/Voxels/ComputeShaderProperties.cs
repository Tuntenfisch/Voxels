...
namespace Voxels
{
    internal static class ComputeShaderProperties
    {
        ...
        public static readonly int s_generatedVertexIndicesLookupTable = Shader.PropertyToID("generatedVertexIndicesLookupTable");
        ...
        public static readonly int s_schmitzParticleIterations = Shader.PropertyToID("schmitzParticleIterations");
        ...
        public static readonly int s_schmitzParticleStepSize = Shader.PropertyToID("schmitzParticleStepSize");
